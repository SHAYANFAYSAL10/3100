...
<html>
    <head>
        <title>RUET admin panel</title>
        <link rel="preconnect" href="https://fonts.gstatic.com">
        <link href="https://fonts.googleapis.com/css2?family=Zen+Dots&display=swap" rel="stylesheet">
		<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
		<link rel="stylesheet" type="text/css" href="RUET_admin.css">
    </head>
    <body>
    <?php
        session_start();
    ...
    <header>
        ...
        <div class="pdf_div">
        <form class="pdf" action="RUET_admin.php" method="post" enctype="multipart/form-data">
            <h1>Insert</h1>
            ...
            <?php
                ...
                if(isset($_POST['submit1']))
                {
                    ...
                    $sql="INSERT INTO ruet(ID,pdf) values($_POST[id1],'$pdf')";
        ...
        <form class="pdf" action="RUET_admin.php" method="post" enctype="multipart/form-data">
            ...
            <?php
                ...
                if(isset($_POST['submit2']))
                {
                    ...
                    move_uploaded_file($pdf_tem_loc,$pdf_store);
                    $sql="UPDATE `ruet` SET `pdf`='$pdf' WHERE ID=$_POST[id2]";
                    $query=mysqli_query($con,$sql);
                }
            ?>
        </form>
        ...
        <form class="pdf" action="RUET_admin.php" method="post" enctype="multipart/form-data">
            ...
            <?php
                ...
                {
                    $sql="DELETE FROM `ruet` WHERE ID=$_POST[id3]";
                    $query=mysqli_query($con,$sql);
                }
            ?>
        </form></br></br>
