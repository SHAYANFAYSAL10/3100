...
<html>
    <head>
		...
		<link rel="stylesheet" type="text/css" href="JUST_admin.css">
    </head>
    <body>
    <?php
        session_start();
    ...
    <header>
        ...
        <div class="pdf_div">
        <form class="pdf" action="JUST_admin.php" method="post" enctype="multipart/form-data">
            <h1>Insert</h1>
            ...
            <?php
                ...
                if(isset($_POST['submit1']))
                {
                    ...
                    $sql="INSERT INTO just(ID,pdf) values($_POST[id1],'$pdf')";
        ...
        <form class="pdf" action="JUST_admin.php" method="post" enctype="multipart/form-data">
            ...
            <?php
                ...
                if(isset($_POST['submit2']))
                {
                    ...
                    move_uploaded_file($pdf_tem_loc,$pdf_store);
                    $sql="UPDATE `just` SET `pdf`='$pdf' WHERE ID=$_POST[id2]";
                    $query=mysqli_query($con,$sql);
                }
            ?>
        </form>
        ...
        <form class="pdf" action="JUST_admin.php" method="post" enctype="multipart/form-data">
            ...
            <?php
                ...
                {
                    $sql="DELETE FROM `just` WHERE ID=$_POST[id3]";
                    $query=mysqli_query($con,$sql);
                }
            ?>
        </form></br></br>
